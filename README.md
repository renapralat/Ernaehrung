...
- **Export** als Text oder CSV, sowie als **Brief** (Klartext-Tabellenform für den Arzt): zeigt ganz oben Makroziel (Eiweiß/Fett/KH-Verhältnis) und aktuelles Kalorienziel; pro Tag direkt unter dem Datum die Notiz (falls vorhanden), Schritte samt Bewegungs-kcal, Netto-kcal, Abweichung vom Kalorienziel und die tatsächlichen Makro-Anteile im Vergleich zum Ziel; die Einträge werden nach Kategorie gruppiert (Frühstück, Mittag, Abendessen zuerst in dieser Reihenfolge, danach Snack/Gaststätte/eigene Kategorien/„Ohne Kategorie" in beliebiger Reihenfolge) – die Zwischensumme steht direkt in der Kategoriezeile, darunter der Trennstrich, danach die Einzelposten; am Ende die Tagesgesamtsumme – Lysin/Arginin werden in der Briefform bewusst weggelassen, da für die ärztliche Beurteilung uninteressant (bleiben im Tab/CSV-Export erhalten)
