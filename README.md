...
- **Wiederholen**: frühere Mahlzeiten mit einem Klick neu erfassen – das Original-Datum wird dabei als Vorschlag ins Datumsfeld übernommen (z.B. um alte, inzwischen korrigierbare Einträge nachträglich richtigzustellen), lässt sich aber vor dem Speichern jederzeit auf ein anderes Datum oder Heute ändern
