...
- **Wiederholen**: frühere Mahlzeiten mit einem Klick neu erfassen – weicht das Original-Datum vom heutigen Tag ab, fragt die App aktiv nach ("📅 Original-Datum" oder "📅 Heute"), damit die Entscheidung nicht übersehen wird (z.B. um alte, inzwischen korrigierbare Einträge nachträglich richtigzustellen); ist der Eintrag von heute, wird ohne Nachfrage direkt Heute verwendet
